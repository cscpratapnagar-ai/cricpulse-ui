...
const modulePage = (title: string, description: string) => ({
...
export const routes: Routes = [
  ...
  // Direct Live Scoring V2 entry points. Keep the canonical match route while allowing deep links from dashboards, notifications and external workflows.
  {
    ...
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: LiveScoringV2Component }],
  },
  {
    path: 'scoring/:id',
    component: DashboardComponent,
  ...
  },
  {
    ...
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: CreateMatchComponent }],
  },
  {
    path: 'matches/:id/playing-xi',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: PlayingXiV2Component }],
  },
  {
    path: 'matches/:id/toss',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: TossComponent }],
  },
  {
    path: 'matches/:id/opening-players',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: OpeningPlayersComponent }],
  },
  {
    path: 'matches/:id/live-scoring',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: LiveScoringV2Component }],
  },
  {
    ...
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: MatchResultComponent }],
  },
  {
    path: 'matches/:id/scorecard',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: MatchScorecardComponent }],
  },
  {
    path: 'matches/:id/statistics',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: MatchStatisticsComponent }],
  },
  {
    path: 'matches/:id/live',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: LiveMatchEntryComponent }],
  },
  {
    path: 'matches/:id/scorer',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: ScorerComponent }],
  },
  {
    path: 'matches/:id/overview',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: MatchDetailComponent }],
  },
  {
    path: 'matches/:id',
    component: DashboardComponent,
  ...
  },
  {
    ...
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: PlayerStatisticsComponent }],
  },
  {
    path: 'players/compare',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: PlayerComparisonComponent }],
  },
  {
    path: 'players/:id/form',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: PlayerFormComponent }],
  },
  {
    path: 'players/:id',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: PlayerProfileComponent }],
  },
  {
    path: 'tournaments/new',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: CreateTournamentComponent }],
  },
  {
    path: 'tournaments/:id/qualification',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: TournamentQualificationComponent }],
  },
  {
    path: 'tournaments/:id/schedule',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: TournamentScheduleComponent }],
  },
  {
    path: 'tournaments/:id/analytics',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: TournamentAnalyticsComponent }],
  },
  {
    path: 'tournaments/:id',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: TournamentDetailComponent }],
  },
  {
    path: 'tournaments',
    component: DashboardComponent,
  ...
  },
  {
    ...
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: LiveCenterComponent }],
  },
  {
    path: 'scorer',
    component: DashboardComponent,
  ...
  },
  {
    ...
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: CreateTeamComponent }],
  },
  {
    path: 'teams/:id/players/bulk',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: BulkTeamPlayersV2Component }],
  },
  {
    path: 'teams/:id',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: TeamDetailComponent }],
  },
  {
    path: 'players',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: PlayersComponent }],
  },
  {
    path: 'analytics',
    component: DashboardComponent,
  ...
  },
  {
    ...
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: LeaderboardsComponent }],
  },
  {
    path: 'settings',
    component: DashboardComponent,
  ...
  },
  {
    ...
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: AccountProfileComponent }],
  },
  {
    path: 'ui-states',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: StateGalleryComponent }],
  },
  {
    path: 'player/onboarding',
    component: DashboardComponent,
    canActivate: [authGuard],
    children: [{ path: '', component: PlayerOnboardingComponent }],
  },
