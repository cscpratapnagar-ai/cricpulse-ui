...
export class DashboardComponent {
  ...
  private get accessibleCommandItems() {
  ...
  openCommand() {
    this.commandQuery = '';
    this.commandResults.set(this.accessibleCommandItems);
  ...
  updateCommand() {
    ...
    this.commandResults.set(
      this.accessibleCommandItems.filter(
        (x) => !q || (x.label + ' ' + x.group).toLowerCase().includes(q),
      ),
    );
  }
