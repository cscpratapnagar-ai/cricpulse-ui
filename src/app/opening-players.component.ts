  ...
  @if(loading){
    ...
    @if(existingInnings && existingInnings.status==='LIVE'){
      ...
      <section class="selection-workspace">
        ...
        <section class="selection-preview" aria-label="Opening combination preview">
