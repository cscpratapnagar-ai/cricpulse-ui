...
@media(max-width:1100px){.team-grid{grid-template-columns:1fr}.selection-board{min-height:380px}}@media(max-width:760px){.xi-page{padding:28px 17px 100px}.hero{padding:20px}.hero-main{align-items:flex-start;flex-direction:column}.fixture-mini{display:flex;align-items:center;gap:8px;justify-items:start;text-align:left}.teams-line{grid-template-columns:minmax(0,1fr) 36px minmax(0,1fr);padding:13px 11px}.teams-line>div{gap:7px}.teams-line i{width:31px;height:31px;flex-basis:31px}.teams-line strong{font-size:14px}.progress{grid-template-columns:1fr;gap:10px}.progress-meta{display:none}.role-grid{grid-template-columns:1fr}.selection-board{grid-template-columns:1fr}.xi-list{border-left:0;border-top:1px solid var(--line)}.sticky-bar{align-items:stretch;flex-direction:column}.continue{justify-content:center}.loading-grid{grid-template-columns:1fr}.shimmer.card{height:300px}}@media(prefers-reduced-motion:reduce){*,*:before,*:after{animation-duration:.01ms!important;transition-duration:.01ms!important}}`]
})
