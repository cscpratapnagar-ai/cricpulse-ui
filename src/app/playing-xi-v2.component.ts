                  ...
                  <div class="players-scroll">
                    @for (m of team.members; track m.playerId) {
                      <article class="player-row" [class.selected]="isSelected(team,m.playerId)">
                        ...
                        <div class="player-copy"><b [title]="m.fullName">{{m.fullName}}</b><small>{{m.role || 'Player'}}</small></div>
                        <button [class.remove]="isSelected(team,m.playerId)" [disabled]="match.status!=='SCHEDULED' || (!isSelected(team,m.playerId) && team.selected.length>=11)" (click)="toggle(team,m)">
                          <span class="action-icon" aria-hidden="true">{{isSelected(team,m.playerId)?'✓':'+'}}</span><span class="action-label">{{isSelected(team,m.playerId)?'Selected':'Add'}}</span>
                        </button>
                      </article>
                    } @empty { <div class="empty">No registered players available for this side.</div> }
                  </div>
                </section>
...
.back-link{display:inline-flex;align-items:center;gap:8px;margin-bottom:26px;color:var(--muted);text-decoration:none;font-size:9px;font-weight:900;letter-spacing:1.5px;transition:.2s}.back-link span{font-size:16px}.back-link:hover{color:var(--accent);transform:translateX(-2px)}
.hero{padding:27px 29px;border:1px solid var(--line);border-radius:24px;background:linear-gradient(145deg,var(--surface),var(--raised));box-shadow:0 24px 65px color-mix(in srgb,#000 10%,transparent)}.hero-top,.hero-main{display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.eyebrow{display:flex;align-items:center;gap:8px;color:var(--accent);font-size:8px;font-weight:900;letter-spacing:1.8px}.eyebrow i,.sticky-state>i{width:6px;height:6px;border-radius:50%;background:var(--accent);box-shadow:0 0 14px var(--accent)}.status{display:inline-flex;align-items:center;gap:7px;padding:7px 10px;border:1px solid var(--line);border-radius:999px;color:var(--muted);font-size:8px;font-weight:900;letter-spacing:1px}.status span{width:6px;height:6px;border-radius:50%;background:var(--accent);box-shadow:0 0 10px var(--accent)}.hero-main{align-items:flex-end;margin-top:18px}.hero-copy{min-width:0}.hero h1{margin:0 0 7px;color:var(--ink);font-size:clamp(30px,4vw,50px);line-height:1;letter-spacing:-2px}.hero p{max-width:660px;margin:0;color:var(--muted);font-size:12px;line-height:1.6}.fixture-mini{display:grid;justify-items:end;gap:5px;min-width:115px;text-align:right}.fixture-mini span{padding:5px 8px;border-radius:6px;background:var(--accent-soft);color:var(--accent);font-size:8px;font-weight:900;letter-spacing:1px}.fixture-mini b{font-size:17px;letter-spacing:2px}.fixture-mini small{color:var(--muted);font-size:8px;letter-spacing:1px}
.teams-line{display:grid;grid-template-columns:minmax(0,1fr) 76px minmax(0,1fr);align-items:center;gap:15px;margin-top:24px;padding:15px 18px;border:1px solid var(--line);border-radius:16px;background:color-mix(in srgb,var(--cp-text) 2%,transparent)}.teams-line>div{display:flex;align-items:center;gap:10px;min-width:0}.teams-line .away{justify-content:flex-end;text-align:right}.teams-line i{width:36px;height:36px;flex:0 0 36px;display:grid;place-items:center;border:1px solid color-mix(in srgb,var(--accent) 28%,var(--line));border-radius:11px;background:var(--accent-soft);color:var(--accent);font-style:normal;font-weight:900}.teams-line i.alt{color:#5799e8;background:color-mix(in srgb,#5799e8 10%,transparent);border-color:color-mix(in srgb,#5799e8 25%,var(--line))}.teams-line strong{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px}.teams-line>span{text-align:center;color:var(--muted);font-size:9px;font-weight:900;letter-spacing:1.5px}
.notice{display:flex;align-items:center;gap:12px;margin-top:14px;padding:13px 15px;border:1px solid color-mix(in srgb,#e9636b 25%,var(--line));border-radius:12px;background:color-mix(in srgb,#e9636b 6%,transparent);font-size:10px}.notice b{color:#e9636b}.notice span{color:var(--muted)}
.progress{display:grid;grid-template-columns:185px 1fr 120px;align-items:center;gap:18px;margin:16px 0;padding:14px 17px;border:1px solid var(--line);border-radius:15px;background:var(--surface)}.progress-copy{display:grid;gap:4px}.progress-copy span,.progress-meta{color:var(--muted);font-size:8px;font-weight:900;letter-spacing:1.2px}.progress-copy b{font-size:14px}.progress-copy small{color:var(--muted);font-size:9px}.progress-track{height:5px;overflow:hidden;border-radius:99px;background:color-mix(in srgb,var(--cp-text) 7%,transparent)}.progress-track i{display:block;height:100%;min-width:2px;border-radius:inherit;background:var(--accent);box-shadow:0 0 12px color-mix(in srgb,var(--accent) 60%,transparent);transition:width .35s ease}.progress-meta{display:flex;justify-content:space-between}.progress-meta span:last-child{color:var(--accent)}
.team-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.team-card{min-width:0;border:1px solid var(--line);border-radius:21px;background:var(--surface);overflow:visible;box-shadow:0 15px 42px color-mix(in srgb,#000 6%,transparent)}.team-head{display:flex;justify-content:space-between;align-items:center;gap:14px;padding:20px;border-bottom:1px solid var(--line)}.team-identity{display:flex;align-items:center;gap:11px;min-width:0}.team-badge{width:40px;height:40px;flex:0 0 40px;display:grid;place-items:center;border-radius:13px;background:var(--accent-soft);border:1px solid color-mix(in srgb,var(--accent) 26%,var(--line));color:var(--accent);font-weight:900}.away-badge{color:#5799e8;background:color-mix(in srgb,#5799e8 10%,transparent);border-color:color-mix(in srgb,#5799e8 24%,var(--line))}.team-identity span,.section-label span,.roles small{display:block;color:var(--muted);font-size:8px;font-weight:900;letter-spacing:1.25px}.team-identity h2{max-width:280px;margin:4px 0 0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:17px;letter-spacing:-.5px}.count{display:flex;align-items:baseline;gap:3px;padding:8px 10px;border-radius:10px;background:var(--accent-soft);color:var(--accent)}.count b{font-size:17px}.count span{font-size:9px;font-weight:800}
.roles-panel{position:relative;z-index:20;padding:15px;border-bottom:1px solid var(--line);background:color-mix(in srgb,var(--cp-text) 1.5%,transparent)}.section-label{display:flex;justify-content:space-between;align-items:center;gap:10px;margin-bottom:11px}.section-label>div{display:grid;gap:3px}.section-label b{font-size:11px}.section-label em{color:var(--muted);font-size:8px;font-style:normal}.save-role{border:1px solid color-mix(in srgb,var(--accent) 30%,var(--line));border-radius:8px;padding:7px 10px;background:var(--accent);color:var(--cp-accent-contrast);font-size:9px;font-weight:900;cursor:pointer;transition:.2s}.save-role:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 8px 20px color-mix(in srgb,var(--accent) 18%,transparent)}.save-role:disabled{opacity:.45;cursor:not-allowed}.role-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}
.selection-board{display:grid;grid-template-columns:1fr 1fr;min-height:450px}.squad-list,.xi-list{min-width:0;padding:15px}.xi-list{border-left:1px solid var(--line);background:color-mix(in srgb,var(--cp-text) 1.5%,transparent)}.compact{margin-bottom:12px}.players-scroll,.xi-scroll{max-height:420px;overflow:auto;padding-right:3px}.player-row,.xi-row{display:flex;align-items:center;gap:8px;padding:8px;border:1px solid transparent;border-radius:11px;margin-bottom:5px;transition:.18s}.player-row{background:color-mix(in srgb,var(--cp-text) 2%,transparent);border-color:var(--line)}.player-row:hover{border-color:var(--strong);transform:translateX(1px)}.player-row.selected{background:var(--accent-soft);border-color:color-mix(in srgb,var(--accent) 30%,var(--line))}.avatar{width:31px;height:31px;flex:0 0 31px;display:grid;place-items:center;border-radius:9px;background:var(--raised);color:var(--accent);font-size:9px;font-weight:900}.player-copy{min-width:0;flex:1;display:grid;gap:3px}.player-copy>b{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:10px}.player-copy small{color:var(--muted);font-size:8px}.player-row button{display:inline-flex;align-items:center;justify-content:center;gap:5px;min-width:45px;height:30px;border:0;border-radius:9px;padding:0 9px;background:var(--accent);color:var(--cp-accent-contrast);font-size:8px;font-weight:900;line-height:1;cursor:pointer;white-space:nowrap}.player-row button .action-icon{display:grid;place-items:center;width:11px;height:11px;font-size:13px;font-weight:800;line-height:11px;transform:translateY(-.5px)}.player-row button .action-label{line-height:1}.player-row button.remove{background:transparent;color:var(--accent);border:1px solid color-mix(in srgb,var(--accent) 30%,var(--line))}.player-row button:disabled{opacity:.42;cursor:not-allowed}
.xi-row{border-bottom:1px solid var(--line);border-radius:0;margin:0;padding:10px 4px}.order{width:25px;flex:0 0 25px;color:var(--muted);font-size:9px;font-weight:900}.tags{display:flex;align-items:center;gap:4px;min-height:12px}.tags span{padding:2px 4px;border-radius:4px;background:var(--accent-soft);color:var(--accent);font-size:7px;font-weight:900}.tags small{font-size:7px;letter-spacing:.7px}.xi-row>button{width:25px;height:25px;border:0;border-radius:7px;background:transparent;color:var(--muted);font-size:18px;cursor:pointer;transition:.15s}.xi-row>button:hover:not(:disabled){background:color-mix(in srgb,#e9636b 10%,transparent);color:#e9636b}.xi-row>button:disabled{opacity:.4}.xi-empty{min-height:300px;display:grid;place-content:center;justify-items:center;text-align:center;gap:7px;color:var(--muted)}.xi-empty>div{width:48px;height:48px;display:grid;place-items:center;border:1px dashed var(--strong);border-radius:15px;color:var(--accent);font-size:12px;font-weight:900}.xi-empty b{margin-top:5px;color:var(--ink);font-size:10px}.xi-empty span{max-width:180px;font-size:9px;line-height:1.6}.empty,.loading{padding:35px 15px;text-align:center;color:var(--muted);font-size:10px}.access-denied{padding:38px 28px;text-align:center}.lock{width:42px;height:42px;margin:0 auto 12px;display:grid;place-items:center;border-radius:13px;background:var(--accent-soft);color:var(--accent);font-size:19px}.access-denied b{font-size:12px}.access-denied p{margin:7px auto 0;max-width:360px;color:var(--muted);font-size:10px;line-height:1.6}.roles{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;padding:14px;border-top:1px solid var(--line)}.roles div{min-width:0;padding:10px;border:1px solid var(--line);border-radius:10px;background:color-mix(in srgb,var(--cp-text) 2%,transparent);display:grid;gap:5px}.roles strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:10px}
.sticky-bar{position:sticky;z-index:15;bottom:18px;display:flex;justify-content:space-between;align-items:center;gap:18px;margin-top:18px;padding:12px 14px 12px 17px;border:1px solid color-mix(in srgb,var(--accent) 22%,var(--line));border-radius:15px;background:color-mix(in srgb,var(--surface) 92%,transparent);backdrop-filter:blur(18px);box-shadow:0 18px 48px color-mix(in srgb,#000 15%,transparent)}.sticky-state{display:flex;align-items:center;gap:10px}.sticky-state>i{animation:pulse 1.8s infinite}.sticky-state>div{display:grid;gap:3px}.sticky-state span{color:var(--accent);font-size:8px;font-weight:900;letter-spacing:1.2px}.sticky-state b{color:var(--muted);font-size:9px;font-weight:500}.continue{display:inline-flex;align-items:center;gap:14px;height:42px;padding:0 14px;border-radius:10px;background:var(--accent);color:var(--cp-accent-contrast);font-size:9px;font-weight:900;text-decoration:none;transition:.2s}.continue:hover{transform:translateY(-2px);box-shadow:0 12px 25px color-mix(in srgb,var(--accent) 22%,transparent)}.continue.disabled{opacity:.42;pointer-events:none;filter:saturate(.35)}
.toast{position:fixed;right:22px;bottom:24px;z-index:1500;display:flex;align-items:center;gap:9px;padding:11px 14px;border:1px solid color-mix(in srgb,var(--accent) 25%,var(--line));border-radius:11px;background:var(--surface);box-shadow:0 16px 40px color-mix(in srgb,#000 18%,transparent);font-size:10px;animation:toastIn .22s ease-out}.toast i{width:19px;height:19px;display:grid;place-items:center;border-radius:50%;background:var(--accent);color:var(--cp-accent-contrast);font-style:normal;font-weight:900}
...
@media(max-width:1100px){.team-grid{grid-template-columns:1fr}.selection-board{min-height:380px}}@media(max-width:760px){.xi-page{padding:28px 17px 100px}.hero{padding:20px}.hero-main{align-items:flex-start;flex-direction:column}.fixture-mini{display:flex;align-items:center;gap:8px;justify-items:start;text-align:left}.teams-line{grid-template-columns:minmax(0,1fr) 36px minmax(0,1fr);padding:13px 11px}.teams-line>div{gap:7px}.teams-line i{width:31px;height:31px;flex-basis:31px}.teams-line strong{font-size:10px}.progress{grid-template-columns:1fr;gap:10px}.progress-meta{display:none}.role-grid{grid-template-columns:1fr}.selection-board{grid-template-columns:1fr}.xi-list{border-left:0;border-top:1px solid var(--line)}.sticky-bar{align-items:stretch;flex-direction:column}.continue{justify-content:center}.loading-grid{grid-template-columns:1fr}.shimmer.card{height:300px}}@media(prefers-reduced-motion:reduce){*,*:before,*:after{animation-duration:.01ms!important;transition-duration:.01ms!important}}`]
})
