    ...
    @if(tab==='squad'){
      <section class="panel squad-panel">
        <div class="panel-head squad-toolbar">
          ...
          <div class="toolbar-controls"><input [(ngModel)]="query" placeholder="Search squad..." aria-label="Search squad"><div class="select-shell"><select class="cp-select" [(ngModel)]="roleFilter" aria-label="Filter squad by role"><option value="ALL">All roles</option><option value="OWNER">Owner</option><option value="MANAGER">Manager</option><option value="CAPTAIN">Captain</option><option value="VICE_CAPTAIN">Vice captain</option><option value="PLAYER">Player</option></select></div></div>
        </div>
        @if(showAdd && access?.canManage){
          <div class="add-drawer">
            ...
            <div class="select-shell"><select class="cp-select" [(ngModel)]="role" aria-label="New player role"><option value="PLAYER">Player</option><option value="CAPTAIN">Captain</option><option value="VICE_CAPTAIN">Vice captain</option><option value="MANAGER">Manager</option></select></div>
            ...
            <article class="member-row">
              ...
              @if(access?.canManage){
                <div class="member-actions">
                  <div class="select-shell member-select"><select class="cp-select" [ngModel]="m.role" [disabled]="m.role==='OWNER'||saving" [attr.aria-label]="'Change role for ' + m.fullName" (ngModelChange)="changeRole(m,$event)"><option value="OWNER">Owner</option><option value="MANAGER">Manager</option><option value="CAPTAIN">Captain</option><option value="VICE_CAPTAIN">Vice captain</option><option value="PLAYER">Player</option></select></div>
