      ...
      <section class="setup-panel">
        ...
        <div class="winner-grid">
          <button type="button" class="winner-card" [class.selected]="winnerTeamId===match?.teamAId" [disabled]="saved" (click)="winnerTeamId=match?.teamAId||''">
            <div class="card-glow"></div><div class="winner-top"><span class="team-avatar">{{(match?.teamAName||'A').slice(0,1)}}</span><span class="choice-indicator"><i></i></span></div>
          ...
          <button type="button" class="winner-card" [class.selected]="winnerTeamId===match?.teamBId" [disabled]="saved" (click)="winnerTeamId=match?.teamBId||''">
            <div class="card-glow"></div><div class="winner-top"><span class="team-avatar">{{(match?.teamBName||'B').slice(0,1)}}</span><span class="choice-indicator"><i></i></span></div>
