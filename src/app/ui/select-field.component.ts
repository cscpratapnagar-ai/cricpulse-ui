...
@Component({
  ...
  styles: [`:host{display:block}.field{display:grid;gap:8px;color:var(--cp-text);font-size:11px;font-weight:750}.select-wrap{position:relative}.select-trigger{display:flex;align-items:center;justify-content:space-between;box-sizing:border-box;width:100%;height:48px;padding:0 13px;border:1px solid var(--cp-border);border-radius:12px;background:color-mix(in srgb,var(--cp-text) 2%,transparent);color:var(--cp-text);outline:none;font:inherit;text-align:left;cursor:pointer;transition:border-color .2s,box-shadow .2s,background .2s}.select-trigger:hover:not(:disabled),.select-trigger.open{border-color:color-mix(in srgb,var(--cp-accent) 58%,var(--cp-border));box-shadow:0 0 0 3px var(--cp-accent-soft);background:var(--cp-surface)}.select-trigger b{color:var(--cp-accent);font-size:12px;transition:transform .2s}.select-trigger.open b{transform:rotate(180deg)}.select-trigger.disabled{opacity:.5;cursor:not-allowed}.muted{color:var(--cp-text-muted)}.options{position:absolute;z-index:1000;top:56px;left:0;width:100%;box-sizing:border-box;max-height:235px;overflow-y:auto;padding:6px;border:1px solid var(--cp-border-strong);border-radius:13px;background:var(--cp-surface);box-shadow:var(--cp-shadow-sm),0 20px 45px color-mix(in srgb,#000 12%,transparent);backdrop-filter:blur(18px)}.options.up{top:auto;bottom:56px}.option{display:block;width:100%;padding:11px 12px;border:0;border-radius:8px;background:transparent;color:var(--cp-text);font:inherit;text-align:left;cursor:pointer;transition:background .15s,color .15s}.option:hover,.option.active{background:var(--cp-accent);color:var(--cp-accent-contrast);font-weight:850}.placeholder-option{color:var(--cp-text-muted);border-bottom:1px solid var(--cp-border);border-radius:5px}@media(max-width:650px){.options{max-height:200px}}` ]
})
