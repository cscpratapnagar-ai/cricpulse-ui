    ...
    <label class="field">
      ...
      @if(open){
        <div class="picker" [class.up]="openUp">
          ...
          <div class="picker-foot"><button type="button" (click)="clear()">Clear</button><button type="button" (click)="today()">Today</button></div>
        </div>
      }
    </label>
  `,
...
export class DateTimeFieldComponent {
  ...
  open = false; openUp = false; viewDate = new Date(); selectedDate: Date | null = null; hour = '12'; minute = '00'; period = 'PM';
  weekdays = ['Su','Mo','Tu','We','Th','Fr','Sa']; hours = Array.from({length:12},(_,i)=>String(i+1)); minutes = ['00','15','30','45'];
