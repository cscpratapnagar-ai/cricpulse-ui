...
.back-link{display:inline-flex;align-items:center;gap:8px;margin-bottom:26px;color:var(--muted);text-decoration:none;font-size:13px;font-weight:800;letter-spacing:.35px;transition:.2s}.back-link span{font-size:16px}.back-link:hover{color:var(--accent);transform:translateX(-2px)}
.hero{padding:27px 29px;border:1px solid var(--line);border-radius:24px;background:linear-gradient(145deg,var(--surface),var(--raised));box-shadow:0 24px 65px color-mix(in srgb,#000 10%,transparent)}.hero-top,.hero-main{display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.eyebrow{display:flex;align-items:center;gap:8px;color:var(--accent);font-size:13px;font-weight:800;letter-spacing:.3px}.eyebrow i,.sticky-state>i{width:6px;height:6px;border-radius:50%;background:var(--accent);box-shadow:0 0 14px var(--accent)}.status{display:inline-flex;align-items:center;gap:7px;padding:7px 10px;border:1px solid var(--line);border-radius:999px;color:var(--muted);font-size:13px;font-weight:800;letter-spacing:.2px}.status span{width:6px;height:6px;border-radius:50%;background:var(--accent);box-shadow:0 0 10px var(--accent)}.hero-main{align-items:flex-end;margin-top:18px}.hero-copy{min-width:0}.hero h1{margin:0 0 7px;color:var(--ink);font-size:clamp(30px,4vw,50px);line-height:1;letter-spacing:-2px}.hero p{max-width:660px;margin:0;color:var(--muted);font-size:14px;line-height:1.6}.fixture-mini{display:grid;justify-items:end;gap:5px;min-width:115px;text-align:right}.fixture-mini span{padding:5px 8px;border-radius:6px;background:var(--accent-soft);color:var(--accent);font-size:14px;font-weight:800;letter-spacing:.6px}.fixture-mini b{font-size:16px;letter-spacing:.4px}.fixture-mini small{color:var(--muted);font-size:10px;letter-spacing:.1px}
.teams-line{display:grid;grid-template-columns:minmax(0,1fr) 76px minmax(0,1fr);align-items:center;gap:15px;margin-top:24px;padding:15px 18px;border:1px solid var(--line);border-radius:16px;background:color-mix(in srgb,var(--cp-text) 2%,transparent)}.teams-line>div{display:flex;align-items:center;gap:10px;min-width:0}.teams-line .away{justify-content:flex-end;text-align:right}.teams-line i{width:36px;height:36px;flex:0 0 36px;display:grid;place-items:center;border:1px solid color-mix(in srgb,var(--accent) 28%,var(--line));border-radius:11px;background:var(--accent-soft);color:var(--accent);font-style:normal;font-weight:900}.teams-line i.alt{color:#5799e8;background:color-mix(in srgb,#5799e8 10%,transparent);border-color:color-mix(in srgb,#5799e8 25%,var(--line))}.teams-line strong{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:14px}.teams-line>span{text-align:center;color:var(--muted);font-size:13px;font-weight:800;letter-spacing:.35px}
