...
get visibleTournaments():Tournament[]{const items=[...this.filteredTournaments];if(this.sortKey==='name')return items.sort((a,b)=>a.name.localeCompare(b.name));if(this.sortKey==='status')return items.sort((a,b)=>this.statusKey(a.status).localeCompare(this.statusKey(b.status)));if(this.sortKey==='oldest')return items.sort((a,b)=>String(a.createdAt||'').localeCompare(String(b.createdAt||'')));return items.sort((a,b)=>String(b.createdAt||'').localeCompare(String(a.createdAt||'')));}
