    ...
    @for(innings of scorecards; track innings.inningsId){
      @if(selectedInnings===innings.inningsNumber){
        ...
        <section class="card table-card">
          ...
          <div class="table-wrap"><table><thead><tr><th>BATTER</th><th>DISMISSAL</th><th>R</th><th>B</th><th>4s</th><th>6s</th><th>SR</th></tr></thead><tbody>
        ...
        <section class="card table-card">
          ...
          <div class="table-wrap"><table><thead><tr><th>BOWLER</th><th>O</th><th>R</th><th>W</th><th>ECON</th></tr></thead><tbody>
