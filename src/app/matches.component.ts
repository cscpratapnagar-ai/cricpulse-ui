...
@Component({
  ...
  styles: [`
    ...
    .intel-strip{display:grid;grid-template-columns:repeat(3,1fr) 1.45fr;border:1px solid var(--line);border-radius:20px;background:linear-gradient(110deg,var(--panel),transparent);overflow:hidden;margin-bottom:28px}.intel-card{min-height:86px;padding:18px 20px;display:flex;align-items:center;gap:12px;border-right:1px solid var(--line);position:relative}.intel-card:last-child{border:0}.intel-icon{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:var(--raised);color:var(--muted);font-weight:900}.live-icon{color:var(--accent);animation:livePulse 1.8s infinite}.intel-card b{display:block;font-size:22px;letter-spacing:-1px}.intel-card span{display:block;color:var(--muted);font-size:10px;margin-top:2px}.intel-card i{position:absolute;width:4px;height:4px;background:var(--accent);border-radius:50%;right:18px;opacity:.55}.intel-card.total{justify-content:space-between;background:linear-gradient(90deg,color-mix(in srgb,var(--accent) 6%,transparent),transparent)}.total small{display:block;color:var(--muted);font-size:8px;font-weight:900;letter-spacing:1.5px;margin-bottom:7px}.total b{font-size:25px}.total b span{display:inline;font-size:11px;color:var(--muted);font-weight:600;margin-left:3px}.mini-bars{height:34px;display:flex;align-items:end;gap:4px}.mini-bars i{position:static;width:5px;background:var(--accent);opacity:.8;border-radius:3px}.mini-bars i:nth-child(1){height:11px}.mini-bars i:nth-child(2){height:22px}.mini-bars i:nth-child(3){height:16px}.mini-bars i:nth-child(4){height:30px}.mini-bars i:nth-child(5){height:24px}
