...
@Component({
  ...
  `,
  styles: [`
    :host{display:block;--lime:#b8f45c;--ink:var(--cp-text,#ecf5ef);--muted:var(--cp-muted,#8b9a91);--line:var(--cp-line,rgba(255,255,255,.09));--panel:var(--cp-panel,rgba(13,27,22,.74));}
    ...
    .ambient{position:absolute;pointer-events:none;filter:blur(70px);opacity:.12;border-radius:50%;z-index:-1}.ambient-one{width:420px;height:420px;background:var(--lime);right:-180px;top:80px}.ambient-two{width:320px;height:320px;background:#52b8ff;left:-180px;top:420px}
    .hero{display:flex;justify-content:space-between;gap:32px;align-items:flex-end;margin-bottom:34px}.eyebrow{display:flex;align-items:center;gap:9px;color:var(--lime);font-size:10px;font-weight:900;letter-spacing:2.2px}.eyebrow span{width:6px;height:6px;border-radius:50%;background:var(--lime);box-shadow:0 0 14px var(--lime)}
    .hero h1{margin:13px 0 12px;font-size:clamp(42px,5.4vw,76px);line-height:.91;letter-spacing:-4.8px;font-weight:850}.hero h1 em{font-style:normal;color:var(--lime)}.hero p{margin:0;max-width:570px;color:var(--muted);font-size:14px;line-height:1.65}
    .hero-actions{display:flex;gap:10px;align-items:center;flex:none}.icon-action,.create-btn{height:48px;border-radius:14px}.icon-action{width:48px;border:1px solid var(--line);background:var(--panel);color:var(--ink);font-size:20px;cursor:pointer;transition:.25s}.icon-action:hover{transform:rotate(45deg);border-color:var(--lime)}.create-btn{display:inline-flex;align-items:center;gap:9px;padding:0 18px;background:var(--lime);color:#102019;text-decoration:none;font-size:12px;font-weight:900;box-shadow:0 16px 34px rgba(184,244,92,.16);transition:.25s}.create-btn:hover{transform:translateY(-2px);box-shadow:0 20px 40px rgba(184,244,92,.25)}.create-btn span{font-size:18px}
    .intel-strip{display:grid;grid-template-columns:repeat(3,1fr) 1.45fr;border:1px solid var(--line);border-radius:20px;background:linear-gradient(110deg,var(--panel),transparent);overflow:hidden;margin-bottom:28px}.intel-card{min-height:86px;padding:18px 20px;display:flex;align-items:center;gap:12px;border-right:1px solid var(--line);position:relative}.intel-card:last-child{border:0}.intel-icon{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:rgba(255,255,255,.055);color:var(--muted);font-weight:900}.live-icon{color:var(--lime);animation:livePulse 1.8s infinite}.intel-card b{display:block;font-size:22px;letter-spacing:-1px}.intel-card span{display:block;color:var(--muted);font-size:10px;margin-top:2px}.intel-card i{position:absolute;width:4px;height:4px;background:var(--lime);border-radius:50%;right:18px;opacity:.55}.intel-card.total{justify-content:space-between;background:linear-gradient(90deg,rgba(184,244,92,.06),transparent)}.total small{display:block;color:var(--muted);font-size:8px;font-weight:900;letter-spacing:1.5px;margin-bottom:7px}.total b{font-size:25px}.total b span{display:inline;font-size:11px;color:var(--muted);font-weight:600;margin-left:3px}.mini-bars{height:34px;display:flex;align-items:end;gap:4px}.mini-bars i{position:static;width:5px;background:var(--lime);opacity:.8;border-radius:3px}.mini-bars i:nth-child(1){height:11px}.mini-bars i:nth-child(2){height:22px}.mini-bars i:nth-child(3){height:16px}.mini-bars i:nth-child(4){height:30px}.mini-bars i:nth-child(5){height:24px}
    .control-bar{display:flex;align-items:center;justify-content:space-between;gap:18px;margin:8px 0 20px}.tabs{display:flex;gap:6px;overflow:auto}.tabs button{border:1px solid transparent;background:transparent;color:var(--muted);padding:9px 12px;border-radius:10px;font-size:10px;font-weight:800;white-space:nowrap;cursor:pointer;transition:.2s}.tabs button span{margin-left:5px;opacity:.65}.tabs button:hover{color:var(--ink);background:rgba(255,255,255,.035)}.tabs button.active{color:var(--lime);border-color:rgba(184,244,92,.2);background:rgba(184,244,92,.07)}.search-box{width:260px;height:42px;display:flex;align-items:center;gap:9px;padding:0 12px;border:1px solid var(--line);border-radius:12px;background:var(--panel);color:var(--muted)}.search-box input{min-width:0;flex:1;border:0;outline:0;background:transparent;color:var(--ink);font:inherit;font-size:11px}.search-box input::placeholder{color:var(--muted)}.search-box button{border:0;background:none;color:var(--muted);cursor:pointer;font-size:16px}
    .list-header{display:flex;justify-content:space-between;margin:0 2px 13px}.list-header span{font-size:9px;letter-spacing:1.5px;font-weight:900;color:var(--muted)}.list-header small{font-size:9px;color:var(--muted);opacity:.65}
    .match-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.match-card{position:relative;padding:22px;border:1px solid var(--line);border-radius:22px;background:linear-gradient(145deg,var(--panel),rgba(8,18,14,.72));overflow:hidden;animation:enter .55s both;animation-delay:var(--delay);transition:transform .28s,border-color .28s,box-shadow .28s}.match-card:before{content:'';position:absolute;inset:0;background:radial-gradient(circle at 100% 0,rgba(184,244,92,.08),transparent 34%);pointer-events:none}.match-card:hover{transform:translateY(-5px);border-color:rgba(184,244,92,.28);box-shadow:0 24px 50px rgba(0,0,0,.18)}.match-card.live-card{border-color:rgba(184,244,92,.25)}.card-no{position:absolute;right:18px;top:15px;color:var(--ink);opacity:.045;font-size:52px;font-weight:900;letter-spacing:-5px}.card-top{position:relative;display:flex;justify-content:space-between;align-items:center}.status{display:inline-flex;align-items:center;gap:7px;padding:7px 10px;border:1px solid var(--line);border-radius:999px;font-size:9px;font-weight:900;letter-spacing:1px;color:var(--muted);background:rgba(255,255,255,.025)}.status i{width:6px;height:6px;border-radius:50%;background:var(--muted)}.status[data-status="LIVE"]{color:var(--lime);border-color:rgba(184,244,92,.24);background:rgba(184,244,92,.07)}.status[data-status="LIVE"] i{background:var(--lime);box-shadow:0 0 0 5px rgba(184,244,92,.09);animation:livePulse 1.6s infinite}.status[data-status="COMPLETED"] i{background:#68d5a0}.status[data-status="SCHEDULED"] i{background:#72bfff}.more{border:0;background:transparent;color:var(--muted);letter-spacing:2px;cursor:pointer}.match-title{position:relative;padding:21px 0 18px}.format{font-size:8px;letter-spacing:1.8px;font-weight:900;color:var(--lime)}.match-title h2{margin:7px 0 7px;font-size:24px;line-height:1.05;letter-spacing:-1.4px}.match-title p{margin:0;color:var(--muted);font-size:10px}
    .versus-zone{position:relative;display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:10px;padding:18px 0;border-top:1px solid var(--line);border-bottom:1px solid var(--line)}.club{min-width:0;display:grid;justify-items:start;gap:5px}.club.away{justify-items:end;text-align:right}.crest{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:linear-gradient(145deg,rgba(184,244,92,.2),rgba(184,244,92,.04));border:1px solid rgba(184,244,92,.18);color:var(--lime);font-size:9px;font-weight:900}.crest.alt{background:linear-gradient(145deg,rgba(98,181,255,.18),rgba(98,181,255,.03));border-color:rgba(98,181,255,.16);color:#86c8ff}.club strong{max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:13px}.club small{font-size:8px;letter-spacing:1.5px;color:var(--muted)}.vs{position:relative;display:grid;place-items:center;width:44px;height:44px;border-radius:50%;background:rgba(255,255,255,.025);border:1px solid var(--line);font-size:9px;font-weight:900;color:var(--muted)}.vs i{position:absolute;width:1px;height:18px;background:var(--line);bottom:-28px}
    .card-footer{display:flex;justify-content:space-between;align-items:center;padding-top:16px}.match-meta{display:flex;gap:10px;align-items:center;color:var(--muted);font-size:9px}.pulse-meta{color:var(--lime)}.card-footer a{color:var(--ink);text-decoration:none;font-size:10px;font-weight:900;transition:.2s}.card-footer a b{color:var(--lime);font-size:15px;margin-left:4px}.card-footer a:hover{color:var(--lime)}
    .state-card{padding:74px 24px;text-align:center;border:1px dashed var(--line);border-radius:24px;background:var(--panel)}.empty-orbit{width:62px;height:62px;margin:0 auto 20px;border:1px solid rgba(184,244,92,.18);border-radius:50%;display:grid;place-items:center;color:var(--lime);box-shadow:0 0 40px rgba(184,244,92,.08)}.state-card .eyebrow{justify-content:center}.state-card h2{margin:13px 0 8px;font-size:30px;letter-spacing:-1.5px}.state-card p{margin:0 auto 22px;max-width:420px;color:var(--muted);font-size:12px;line-height:1.6}.state-card a,.state-card button{display:inline-flex;padding:12px 16px;border:0;border-radius:10px;background:var(--lime);color:#102019;text-decoration:none;font-size:11px;font-weight:900;cursor:pointer}.error-state .state-icon{width:48px;height:48px;margin:auto auto 16px;border-radius:14px;display:grid;place-items:center;background:rgba(255,94,94,.1);color:#ff8787;font-size:20px;font-weight:900}.loading-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:16px}.skeleton-card{height:330px;border:1px solid var(--line);border-radius:22px;padding:22px;background:linear-gradient(90deg,rgba(255,255,255,.025),rgba(255,255,255,.055),rgba(255,255,255,.025));background-size:200% 100%;animation:shimmer 1.3s infinite}.skeleton-card i{display:block;height:14px;width:40%;border-radius:8px;background:rgba(255,255,255,.06);margin-bottom:25px}.skeleton-card i:nth-child(2){height:90px;width:100%;margin-top:35px}.skeleton-card i:nth-child(3){width:70%;margin-top:30px}
