...
.match-page{position:relative;isolation:isolate;max-width:1240px;margin:0 auto;padding:42px 4vw 100px;overflow:hidden}.ambient{position:absolute;z-index:-1;width:360px;height:360px;border-radius:50%;filter:blur(90px);opacity:.09;pointer-events:none}.glow-a{background:var(--accent);right:-180px;top:120px}.glow-b{background:#5b9fff;left:-220px;bottom:80px}.back{display:inline-flex;align-items:center;gap:9px;margin-bottom:34px;color:var(--muted);text-decoration:none;font-size:11px;font-weight:850;letter-spacing:.08em;transition:.2s}.back span{font-size:16px}.back:hover{color:var(--accent);transform:translateX(-2px)}
.match-hero{padding:28px;border:1px solid var(--line);border-radius:25px;background:linear-gradient(145deg,var(--surface),var(--raised));box-shadow:0 25px 65px color-mix(in srgb,#000 11%,transparent)}.hero-top,.hero-title-row{display:flex;justify-content:space-between;align-items:flex-start;gap:20px}.eyebrow,.kicker{display:flex;align-items:center;gap:8px;color:var(--accent);font-size:11px;font-weight:850;letter-spacing:.08em}.eyebrow i{width:6px;height:6px;border-radius:50%;background:var(--accent);box-shadow:0 0 14px var(--accent)}.status{display:inline-flex;align-items:center;gap:7px;padding:7px 10px;border:1px solid var(--line);border-radius:999px;color:var(--muted);font-size:11px;font-weight:850;letter-spacing:.06em}.status span{width:6px;height:6px;border-radius:50%;background:var(--muted)}.status.live{border-color:color-mix(in srgb,#ff626c 32%,var(--line));color:#e9636b}.status.live span{background:#e9636b;box-shadow:0 0 0 4px color-mix(in srgb,#e9636b 14%,transparent);animation:blink 1.5s infinite}.status.done{color:var(--accent);border-color:color-mix(in srgb,var(--accent) 25%,var(--line))}.status.done span{background:var(--accent)}
