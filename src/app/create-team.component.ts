...
export class CreateTeamComponent {
  ...
  submit(): void {
    ...
    // The backend derives ownerId from the authenticated JWT.
    // Never trust a userId supplied by the browser for ownership.
    this.http.post<CreatedTeam>('http://localhost:8080/api/teams', {
      name,
